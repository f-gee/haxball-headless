...
export const util = {
    ...
    setAutoCapacityPassword(numPlayers: number) {
    ...
    async geminiAnalyzeChat(messages: string[]) {
        ...
        const payload = {
            systemInstruction: { parts: [{ text: "Write your output in Turkish. Analyze and commentate on this haxball chat. Summarize the situation from a third person perspective, in very little words, no bullet points, no new lines. One short sentence per player. If you notice a dispute, indicate whose side you picked and why." }] },
